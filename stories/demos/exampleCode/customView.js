...
MyWeek.range = (date, { localizer }) => {
  const start = date
  const end = dates.add(start, 13, 'day') // Todo: Here you can alter the number of days that are displayed.
  ...
  return (
    <Fragment>
      <DemoLink fileName="customView">
        <strong>The Calendar below implements a custom 14-days view</strong>
      </DemoLink>
